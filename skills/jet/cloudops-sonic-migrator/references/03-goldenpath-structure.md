...
Use the tier value (numeric: `1`, `2`, `3`) in the `app.tier` field. PlatformMetadata returns numeric tiers (e.g., `"tier": 3`). `APP_NAME` is the canonical name from PlatformMetadata — it may differ from the repo name.
